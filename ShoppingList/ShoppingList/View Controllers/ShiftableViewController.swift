...
//  Outlets
//
//  Created by Spencer Curtis on 4/23/19.
...
//    @objc func requiredFillWasChanged(_ textField: UITextField) {
//
//        guard let requiredFields = requiredFields else { return }
//
//        if requiredFields.contains(textField) {
//
//            textField.layoutIfNeeded()
//            if let text = textField.text, !text.isEmpty {
//                UIView.animate(withDuration: 0.2) {
//                    textField.backgroundColor = AppearanceHelper.whiteBlue
//                    textField.layer.borderColor = AppearanceHelper.whiteBlue.cgColor
//                }
//            } else {
//                UIView.animate(withDuration: 0.2) {
//                    textField.backgroundColor = AppearanceHelper.whiteRed
//                    textField.layer.borderColor = AppearanceHelper.whiteRed.cgColor
//                }
//            }
//        }
//    }
